...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="TwitterBot" generation="1" functional="0" release="0" Id="da6f8970-dcb2-4635-9f58-f70c23130e4d" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="TwitterBotGroup" generation="1" functional="0" release="0">
      ...
      <components>
        <groupHascomponents>
          <role name="AsyncTwitterBot" generation="1" functional="0" release="0" software="D:\TwitterBot\TwitterBot\csx\Release\roles\AsyncTwitterBot" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaWorkerHost.exe " memIndex="-1" hostingEnvironment="consoleroleadmin" hostingEnvironmentVersion="2">
            <settings>
