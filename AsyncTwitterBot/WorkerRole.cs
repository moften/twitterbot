...
namespace AsyncTwitterBot
{
    public class WorkerRole : RoleEntryPoint
    {
        ...
        {
            new TwitterSearchRow("#publicidad"),
           new TwitterSearchRow("#marketing"),
           new TwitterSearchRow("#marketingdigital"),
           new TwitterSearchRow("#redessociales"),
           new TwitterSearchRow("#socialmedia"),
           new TwitterSearchRow("#marketingonline"),
